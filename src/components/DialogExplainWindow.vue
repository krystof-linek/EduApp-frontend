    ...
    <v-dialog :width="dialogWidth" v-model="dialog" persistent>
      <v-card>
        ...
        <v-card-text class="pa-2 pa-md-6 pa-lg-8" :style="descriptionFontStyle">
          ...
          <v-card outlined color="transparent" v-if="propEquation != ''" class="mt-1 mb-1 ma-2 mt-sm-2 mb-sm-2 py-sm-4">
              <vue-mathjax :style="equationFontStyle" :formula="propEquation"></vue-mathjax>
          </v-card>
        </v-card-text>
...
export default {
    ...
    props: {
        propText: {default: ''},
        propTitle: {default: 'Vysvětlení'},
        propPicture: {default: ''},
        propEquation: {default: ''},
    },
    data () {
      return {
        dialog: true,
